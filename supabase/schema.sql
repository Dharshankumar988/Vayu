...
INSERT INTO public.data_centers (id, name, location, region, lat, lng, status, total_capacity) VALUES
  ('dc000000-0000-0000-0000-000000000001', 'US East (N. Virginia)', 'Ashburn, VA', 'us-east-1', 39.0438, -77.4874, 'operational', 500),
  ('dc000000-0000-0000-0000-000000000002', 'US West (N. California)', 'San Jose, CA', 'us-west-1', 37.3382, -121.8863, 'operational', 300),
  ('dc000000-0000-0000-0000-000000000003', 'Europe (Frankfurt)', 'Frankfurt, Germany', 'eu-central-1', 50.1109, 8.6821, 'operational', 450),
  ('dc000000-0000-0000-0000-000000000004', 'Asia Pacific (Tokyo)', 'Tokyo, Japan', 'ap-northeast-1', 35.6895, 139.6917, 'operational', 600);

-- Seed Racks
INSERT INTO public.racks (id, data_center_id, name) VALUES
  ('rk000000-0000-0000-0000-000000000001', 'dc000000-0000-0000-0000-000000000001', 'US-E1-A01'),
  ('rk000000-0000-0000-0000-000000000002', 'dc000000-0000-0000-0000-000000000001', 'US-E1-A02'),
  ('rk000000-0000-0000-0000-000000000003', 'dc000000-0000-0000-0000-000000000002', 'US-W1-B01'),
  ('rk000000-0000-0000-0000-000000000004', 'dc000000-0000-0000-0000-000000000004', 'AP-T1-C01');

-- Seed Servers (Assigning to clients)
INSERT INTO public.servers (id, rack_id, client_id, name, status, unit_position) VALUES
  ('sv000000-0000-0000-0000-000000000001', 'rk000000-0000-0000-0000-000000000001', 'a1b2c3d4-0000-0000-0000-000000000003', 'Stark-Prod-Web-1', 'active', 1),
  ('sv000000-0000-0000-0000-000000000002', 'rk000000-0000-0000-0000-000000000001', 'a1b2c3d4-0000-0000-0000-000000000003', 'Stark-Prod-DB-1', 'active', 2),
  ('sv000000-0000-0000-0000-000000000003', 'rk000000-0000-0000-0000-000000000003', 'a1b2c3d4-0000-0000-0000-000000000004', 'Wayne-Analytics-Node', 'active', 1),
  ('sv000000-0000-0000-0000-000000000004', 'rk000000-0000-0000-0000-000000000004', NULL, 'Available-Node-JP-1', 'idle', 1);
